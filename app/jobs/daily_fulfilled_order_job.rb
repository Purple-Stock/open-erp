...
# DailyFulfilledOrderJob perform against created orders set previously
# with another status.
...
# There are orders status over counted. There are possibilities they became FULFILLED on bling API
class DailyFulfilledOrderJob < BlingOrderItemCreatorBaseJob
  STATUS = BlingOrderItem::Status::FULFILLED.freeze
